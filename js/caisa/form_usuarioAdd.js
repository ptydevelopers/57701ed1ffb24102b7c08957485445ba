                ...
                success: function(data) {
				   ...
				   //alert(data.info[i].status);
					if(data.status == 1)
					{
							...
							$('#success > .alert-success').append("<strong>El Usuario fue registrado correctamente</strong>");
					...
					else
					{
							...
							$('#success > .alert-danger').append("NO se registro el Usuario");
